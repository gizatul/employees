...
const EmployeesListItem = (props) => {
    ...
    const {name, salary, onDelete, onToggleProp, increase, rise, onChangeSalary} = props; //onDelete - проп кот-й передавали ниже по иерархии т.е. employees-list
    ...
    return ( //Добавляем classNames
        <li className={classNames}> 
            ...
            <input onChange={(e) => onChangeSalary(e.target.value, name)} type="text" className="list-group-item-input" defaultValue={salary + '$'}/> 
